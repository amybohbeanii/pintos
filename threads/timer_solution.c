...
/*new: Compares two threads based on their wake up times */
...
/*  int64_t start = timer_ticks (); */
  /*new: schedule a wake-up time and insert current thread into wait list*/
  struct thread *t = thread=current();
